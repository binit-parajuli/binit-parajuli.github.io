...
- **Programming & Databases**: Python, SQL, Relational & Non-Relational Databases  
- **Data Analysis & Modelling**: Statistical Analysis, Exploratory Data Analysis (EDA), Data Validation, Machine Learning Fundamentals  
- **Data Visualization & Reporting**: Excel (Advanced), Power BI, Reporting Automation  
- **Cloud & DevOps**: AWS, Docker, FastAPI, PGVector  
- **Process & Workflow Optimization**: Data Cleaning, Workflow Optimization, Process Automation  
...
- Developed FastAPI endpoints; containerized with Docker for efficient deployment  
...
- Built Linear, Ridge and Lasso models; evaluated with RMSE and R² to select best model  

### 🗄️ Relational Database Design for an Educational Startup  
**Database Project** – MySQL, ER Modeling, Normalization, Business Process Optimization  
- Designed relational database to streamline scheduling, student tracking, resource management and payments  
- Conducted requirements analysis, developed ER diagram, normalized data to reduce redundancy  
- Created structured tables for students, tutors, sessions, resources and payments  
- Improved operational efficiency, reduced double-bookings and supported scalable data management  

### 🌐 Database Design for Scalable Digital Learning Ecosystem  
**Database Project** – MongoDB, Schema Design, Scalability, User Engagement  
- Developed scalable document-oriented database supporting personalized learning, gamification and community tools  
- Designed flexible schemas for content, subscriptions, usage tracking and learner analytics  
- Built real-time dashboards, improved performance and content management  
...
- Delivered actionable insights to optimize sales, inventory and marketing strategies  
...
- Coordinated with universities, training providers and service partners to expand placement options  
- Led marketing, staff development and strategic planning to strengthen business performance  

### 📦 Team Lead  
**Paramount Liquor** – Sydney | Nov 2016 – Dec 2019  
- Oversaw daily warehouse and delivery operations across multiple shifts, ensuring smooth and efficient workflows  
- Managed order accuracy, dispatch timelines and team performance metrics in a fast-paced logistics environment  
- Led regular safety briefings and fostered a proactive safety culture  
- Worked with logistics and inventory teams to improve urgent order handling and stock movement  
...
- Built and nurtured partnerships with global universities and education agents to expand student placement opportunities  
- Developed internal data systems to track application progress, streamline workflows and monitor key success metrics  
- Ensured full compliance with international education and immigration regulations  
